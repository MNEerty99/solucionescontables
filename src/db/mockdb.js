/* -------------------------------------------------------------
   VMP Studio Contable - Mock Database (localStorage wrapper)
   ------------------------------------------------------------- */
...
const DEFAULT_TRANSACTIONS = {
  "co-1": {
    ...
    compras: [
      { id: "c-1", fecha: "2026-05-22", proveedor: "Combustibles YPF", cuit: "30-50001234-9", tipo_comprobante: "Factura A", numero: "4820-00239481", neto: 180000, iva: 37800, total: 217800 },
      { id: "c-2", fecha: "2026-05-14", proveedor: "Repuestos Comahue", cuit: "30-61928374-2", tipo_comprobante: "Factura A", numero: "0002-00001294", neto: 95000, iva: 19950, total: 114950 }
    ]
  },
  "co-2": {
    ventas: [
    ...
    compras: [
      { id: "c-3", fecha: "2026-05-19", proveedor: "Servicios Cloud AWS", cuit: "30-88998899-2", tipo_comprobante: "Factura B", numero: "0934-09827361", neto: 85000, iva: 17850, total: 102850 }
    ]
  },
  "co-3": {
    ventas: [
    ...
    compras: [
      { id: "c-4", fecha: "2026-05-18", proveedor: "Molinos Rio de la Plata", cuit: "30-50000543-1", tipo_comprobante: "Factura A", numero: "0104-00092834", neto: 540000, iva: 113400, total: 653400 }
    ]
  }
};
...
export function saveCompany(company) {
  ...
  if (company.id) {
    ...
    // Inicializar transacciones vacías para la nueva empresa
